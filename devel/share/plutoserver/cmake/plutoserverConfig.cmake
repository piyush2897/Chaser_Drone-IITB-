...
if("TRUE" STREQUAL "TRUE")
  set(plutoserver_SOURCE_PREFIX /home/piyush/catkin_ws/src/pluto_drone/plutoserver)
  set(plutoserver_DEVEL_PREFIX /home/piyush/catkin_ws/devel)
  ...
  set(plutoserver_INSTALL_PREFIX /home/piyush/catkin_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'plutoserver' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Simmu <simranbhangu01@gmail.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'plutoserver' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/piyush/catkin_ws/src/pluto_drone/plutoserver/${idir}'.  Ask the maintainer 'Simmu <simranbhangu01@gmail.com>' to fix it.")
    endif()
...
set(plutoserver_EXPORTED_TARGETS "plutoserver_generate_messages_cpp;plutoserver_generate_messages_lisp;plutoserver_generate_messages_py")
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${plutoserver_dep}_FOUND)
      find_package(${plutoserver_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${plutoserver_dep} REQUIRED ${depend_list})
  endif()
